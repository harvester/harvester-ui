...
export default {
  ...
  computed: {
    ...
    imageName() {
      ...
      const imageId = this.value?.virtualMachineSpec?.dataVolumeTemplates?.[0]?.metadata?.annotations?.['harvester.cattle.io/imageId'] || '';
...
<template>
  <div class="overview-basics">
    ...
    <div class="row">
      <div class="col span-6">
        <LabelValue :name="t('harvester.vmPage.detail.details.bootOrder')">
          <template #value>
            <div>
              <ul>
      ...
      <div class="col span-6">
        <LabelValue :name="t('harvester.vmPage.detail.details.CDROMs')">
          <template #value>
            <div>
